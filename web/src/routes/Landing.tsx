...
const ROW1_TESTIMONIALS = [
  { name: "Brian Ramirez", title: "Financial Analyst", text: "Formly has completely transformed how we gather client feedback. It's user-friendly, efficient, and fits our corporate brand guidelines perfectly!", initial: "B", bg: "bg-emerald-100 text-emerald-700" },
  { name: "David Anderson", title: "Marketing Manager", text: "I love the custom themes! It makes creating branded surveys for our campaigns a breeze. Conversion rates have shot up.", initial: "D", bg: "bg-amber-100 text-amber-700" },
  { name: "James Carter", title: "Graphic Designer", text: "The design tools are fantastic. The survey aesthetics have really helped increase our completion rates on portfolio feedback!", initial: "J", bg: "bg-blue-100 text-blue-700" },
  { name: "Jane Doe", title: "Data Scientist", text: "I've never seen better survey analytics. The response dashboard and csv exports are absolutely top-notch!", initial: "J", bg: "bg-indigo-100 text-indigo-700" },
  { name: "Sarah Lewis", title: "Customer Success", text: "The support team is incredibly helpful and responsive. They resolved our branding questions in a couple of minutes.", initial: "S", bg: "bg-rose-100 text-rose-700" },
]

const ROW2_TESTIMONIALS = [
  { name: "John Mitchell", title: "Product Manager", text: "I appreciate the simplicity. No complex setup means I can launch a feedback survey with confidence in seconds.", initial: "J", bg: "bg-violet-100 text-violet-700" },
  { name: "Daniel Walker", title: "Web Developer", text: "The webhook integrations changed my workflow! Triggering email sequences based on responses is now easier than ever.", initial: "D", bg: "bg-teal-100 text-teal-700" },
  { name: "William Johnson", title: "Sales Executive", text: "The custom redirect feature gives us peace of mind when converting survey leads into booking links. Highly recommend!", initial: "W", bg: "bg-sky-100 text-sky-700" },
  { name: "Joshua White", title: "Business Consultant", text: "I can't believe how quickly we get response notifications. Saves our consulting team so much time analyzing client needs.", initial: "J", bg: "bg-fuchsia-100 text-fuchsia-700" },
  { name: "Emily Watson", title: "HR Coordinator", text: "We use Formly for all our internal employee feedback. The anonymous collection feature is clean, secure, and reliable.", initial: "E", bg: "bg-orange-100 text-orange-700" },
]
  ...
  return (
    <div className="min-h-full bg-slate-950">
      ...
      <main>
        ...
        <div className='fixed h-[4%] w-full bg-transparent backdrop-blur-[10px] top-0 z-40 opacity-100'>
        </div>
        <div className='fixed h-[6%] w-full bg-transparent backdrop-blur-[9px] top-0 z-40 opacity-100'>
        </div>
        <div className='fixed h-[8%] w-full bg-transparent backdrop-blur-[6px] top-0 z-40 opacity-100'>
        </div>
        <div className='fixed h-[10%] w-full bg-transparent backdrop-blur-[5px] top-0 z-40 opacity-100'>
        </div>
        <div className='fixed h-[12%] w-full bg-transparent backdrop-blur-[4px] top-0 z-40 opacity-100'>
        </div>
        <div className='fixed h-[14%] w-full bg-transparent backdrop-blur-[3px] top-0 z-40 opacity-100'>
        </div>
        <div className='fixed h-[16%] w-full bg-transparent backdrop-blur-[2px] top-0 z-40 opacity-100'>
        </div>
        <div className='fixed h-[18%] w-full bg-transparent backdrop-blur-[1px] top-0 z-40 opacity-100'>
        </div>
        {/* top blur */}

        {/* bottom blur */}
        <div className='fixed h-[2%] w-full bg-transparent backdrop-blur-[5px] bottom-0 z-40 opacity-100'>
        </div>
        <div className='fixed h-[4%] w-full bg-transparent backdrop-blur-[10px] bottom-0 z-40 opacity-100'>
        </div>
        <div className='fixed h-[6%] w-full bg-transparent backdrop-blur-[9px] bottom-0 z-40 opacity-100'>
        </div>
        <div className='fixed h-[8%] w-full bg-transparent backdrop-blur-[6px] bottom-0 z-40 opacity-100'>
        </div>
        <div className='fixed h-[10%] w-full bg-transparent backdrop-blur-[5px] bottom-0 z-40 opacity-100'>
        </div>
        <div className='fixed h-[12%] w-full bg-transparent backdrop-blur-[4px] bottom-0 z-40 opacity-100'>
        </div>
        <div className='fixed h-[14%] w-full bg-transparent backdrop-blur-[3px] bottom-0 z-40 opacity-100'>
        </div>
        <div className='fixed h-[16%] w-full bg-transparent backdrop-blur-[2px] bottom-0 z-40 opacity-100'>
        </div>
        <div className='fixed h-[18%] w-full bg-transparent backdrop-blur-[1px] bottom-0 z-40 opacity-100'>
        </div>
        {/* bottom blur */}
        ...
        <section className="relative overflow-hidden border-b border-slate-900 bg-slate-950 py-24 sm:py-32 flex flex-col items-center justify-center min-h-[550px]">
          ...
          <div className="relative z-10 mx-auto max-w-5xl px-4 text-center flex flex-col items-center pointer-events-none">
            {/* Pill Badge */}
            <div className="inline-flex items-center gap-2 rounded-full border border-slate-800 bg-slate-900/50 p-1 pr-3 text-xs text-slate-300 backdrop-blur-sm mb-8 pointer-events-auto">
            ...
            <h1 className="text-4xl font-medium tracking-tight text-white sm:text-6xl md:text-7xl max-w-4xl leading-[1.12] pointer-events-auto">
              <Highlighter isView={true} animationDuration={1000} iterations={2} action="highlight" color="#1D9B5E" >Beautiful</Highlighter>, on-brand surveys <br className="hidden sm:inline" /> made{" "}
              <Highlighter isView={true} animationDuration={1000} iterations={3.5} action="underline" color="#1D9B5E" >
                easy
              </Highlighter>
              .
            </h1>
        ...
        <section id="features" className="bg-white py-24 text-slate-900 border-t border-slate-100">
          <div className="mx-auto max-w-5xl px-4">
            ...
            <div className="grid gap-12 lg:grid-cols-2 items-center">
              ...
              >
                {/* Phone Outer Frame */}
                <motion.div initial={{ y: -200, opacity: 0, filter: 'blur(15px)' }} whileInView={{ y: 0, opacity: 1, filter: 'blur(0px)' }} transition={{ duration: 1, delay: 1 }} viewport={{ once: true, amount: 0.1 }} className="relative w-[250px] h-[450px] rounded-[40px] border-[8px] border-slate-950 bg-white shadow-2xl overflow-hidden flex flex-col shrink-0">
                  ...
                  <div className="absolute top-0 inset-x-0 h-8 px-5 flex items-center justify-between z-20 text-[8px] font-semibold text-slate-900 pointer-events-none">
                    ...
                    <div className="flex items-center gap-1">
                      {/* Signal */}
                      <svg className="w-2.5 h-2.5 text-slate-900" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M2 22h20V2z" />
                      </svg>
                      {/* Wifi */}
                      <svg className="w-2.5 h-2.5 text-slate-900" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="p-4 pt-8 flex-1 flex flex-col justify-between bg-white">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-1.5">
                        ...
                        <div className="flex flex-col">
                          <span className="text-[10px] font-bold text-slate-800 leading-tight">Acme Corp</span>
                          <span className="text-[7.5px] text-slate-400 font-semibold leading-none">Customer Survey</span>
                        </div>
                      </div>
                    ...
                    <div className="bg-brand-500 rounded-[18px] p-3 text-white flex flex-col gap-2.5 shadow-lg shadow-brand-500/10 mt-3">
                      ...
                      <div className="flex items-center justify-between gap-1 mt-0.5">
                        {[1, 2, 3, 4, 5].map((num) => (
                          <button
                            key={num}
                            className={`w-6.5 h-6.5 rounded-full flex items-center justify-center text-[9px] font-bold shadow-sm transition-all cursor-pointer ${num === 5
                      ...
                      <button className="w-full bg-white text-slate-800 rounded-full py-1.5 text-[9px] font-bold hover:bg-slate-50 transition-all shadow-sm flex items-center justify-center gap-1 mt-0.5 cursor-pointer">
                        Next Question
                        <svg className="w-2.5 h-2.5 text-slate-800" fill="none" stroke="currentColor" strokeWidth="3" viewBox="0 0 24 24">
                    ...
                    <div className="mt-3 flex flex-col">
                      <div className="flex justify-between items-center text-xs">
                        <span className="text-slate-800 font-extrabold text-[10px]">Recent Responses</span>
                        <span className="text-brand-500 font-extrabold text-[9px] cursor-pointer hover:underline">See All</span>
                      </div>
                      <div className="flex items-center justify-between gap-1.5 mt-2">
                        {[
                          { name: "Daniel", bg: "bg-emerald-100 text-emerald-700", initial: "D", rating: "5 ★" },
                          { name: "Ethan", bg: "bg-amber-100 text-amber-700", initial: "E", rating: "4 ★" },
                          { name: "Gabriel", bg: "bg-blue-100 text-blue-700", initial: "G", rating: "5 ★" },
                          { name: "Henry", bg: "bg-indigo-100 text-indigo-700", initial: "H", rating: "5 ★" },
                          { name: "James", bg: "bg-rose-100 text-rose-700", initial: "J", rating: "4 ★" },
                        ].map((c) => (
                          <div key={c.name} className="flex flex-col items-center gap-0.5">
                            <div className={`w-8 h-8 rounded-full ${c.bg} flex items-center justify-center text-[9px] font-extrabold border border-black/5 shadow-sm`}>
                              {c.initial}
                            </div>
                            <span className="text-[7px] font-semibold text-slate-500 leading-none mt-0.5">{c.name}</span>
                            <span className="text-[6.5px] font-bold text-slate-400">{c.rating}</span>
                          </div>
                        ))}
                      </div>
                    </div>
              ...
              <div className="flex flex-col justify-center">
                ...
                <p className="text-sm text-slate-500 leading-relaxed mb-8 max-w-lg">
                  Its drag-free, intuitive interface ensures teams can create and publish gorgeous surveys effortlessly, making feedback collection and analysis straightforward and reliable.
                </p>
        ...
        <section id="testimonials" className="bg-white pb-24 pt-10 text-slate-900 border-t border-slate-100 overflow-hidden relative">
          ...
          <div className="mx-auto max-w-5xl px-4">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-sm text-slate-500 leading-relaxed mb-8 max-w-2xl">
                Discover what real clients have to say about how our services have helped them achieve their goals and gather insights effortlessly.
              </p>
            </div>
                  ...
                  >
                    <div>
                      <div className="flex items-center gap-3">
                        <div className={`w-9 h-9 rounded-full ${t.bg} flex items-center justify-center font-bold text-xs shrink-0 border border-black/5`}>
                          {t.initial}
                        </div>
                        <div className="flex flex-col">
                          <span className="text-xs font-bold text-slate-800 leading-tight">{t.name}</span>
                          <span className="text-[10px] text-slate-400 font-semibold leading-tight">{t.title}</span>
                        </div>
                      </div>
            ...
            <div className="relative z-10 flex flex-col items-center max-w-2xl">
              ...
              <div className="flex -space-x-2.5 mb-3.5">
                {[
                  ...
                  <div key={i} className={`w-8 h-8 rounded-full flex items-center justify-center font-bold text-[10px] ${avatar.bg}`}>
                    {avatar.initial}
                  </div>
                ))}
              ...
              <p className="text-sm sm:text-base text-slate-300 leading-relaxed font-light mb-8 max-w-xl">
                Trust us to deliver cutting-edge survey building, custom branding, and real-time analytics, all designed to help you understand your audience effortlessly.
              </p>
      ...
      <footer className="border-t border-slate-900 bg-slate-950 text-slate-400 py-16">
        <div className="mx-auto max-w-5xl px-4">
          <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-5 items-start">

            {/* Column 1: Brand info & Socials */}
            <div className="flex flex-col">
              <Link to="/" className="flex items-center gap-2 text-lg font-bold text-slate-100 w-fit">
                <span className="grid h-7 w-7 place-items-center rounded-lg bg-brand-500 text-sm text-white font-black">
                  F
                </span>
                Formly
              </Link>
              <p className="text-[12px] text-slate-400 font-medium leading-relaxed mt-4 max-w-xs">
                Empowering Your Projects, Enhancing Your Feedback, Every Step of the Way.
              </p>

              {/* Social Icons Row */}
              <div className="flex gap-2.5 mt-6">
                {/* Facebook */}
                <a href="#" className="w-8.5 h-8.5 rounded-xl bg-slate-900 border border-slate-800/80 flex items-center justify-center text-slate-400 hover:bg-slate-800 hover:text-white transition-all cursor-pointer">
            ...
            {/* Column 2: Home Links */}
            <div className="flex flex-col">
              <span className="text-white font-bold text-[13px] uppercase tracking-wider mb-4 block">Home</span>
              <a className="text-slate-400 hover:text-white transition-colors duration-200 block mt-2 text-[12px] font-medium cursor-pointer">Product Features</a>
              <a className="text-slate-400 hover:text-white transition-colors duration-200 block mt-2.5 text-[12px] font-medium cursor-pointer">Benefits</a>
              <a className="text-slate-400 hover:text-white transition-colors duration-200 block mt-2.5 text-[12px] font-medium cursor-pointer">How To Use</a>
              <a className="text-slate-400 hover:text-white transition-colors duration-200 block mt-2.5 text-[12px] font-medium cursor-pointer">Key Features</a>
              <a className="text-slate-400 hover:text-white transition-colors duration-200 block mt-2.5 text-[12px] font-medium cursor-pointer">Pricing</a>
              <a className="text-slate-400 hover:text-white transition-colors duration-200 block mt-2.5 text-[12px] font-medium cursor-pointer">Testimonials</a>
              <a className="text-slate-400 hover:text-white transition-colors duration-200 block mt-2.5 text-[12px] font-medium cursor-pointer">FAQ's</a>
            </div>

            {/* Column 3: App Links */}
            <div className="flex flex-col">
              <span className="text-white font-bold text-[13px] uppercase tracking-wider mb-4 block">App</span>
              <a className="text-slate-400 hover:text-white transition-colors duration-200 block mt-2 text-[12px] font-medium cursor-pointer">Mobile App</a>
              <a className="text-slate-400 hover:text-white transition-colors duration-200 block mt-2.5 text-[12px] font-medium cursor-pointer">Desktop App</a>
              <a className="text-slate-400 hover:text-white transition-colors duration-200 block mt-2.5 text-[12px] font-medium cursor-pointer">How To Use</a>
            </div>

            {/* Column 4: All Pages Links */}
            <div className="flex flex-col">
              <span className="text-white font-bold text-[13px] uppercase tracking-wider mb-4 block">All Pages</span>
              <a className="text-slate-400 hover:text-white transition-colors duration-200 block mt-2 text-[12px] font-medium cursor-pointer">Home</a>
              <a className="text-slate-400 hover:text-white transition-colors duration-200 block mt-2.5 text-[12px] font-medium cursor-pointer">App</a>
              <a className="text-slate-400 hover:text-white transition-colors duration-200 block mt-2.5 text-[12px] font-medium cursor-pointer">Blogs</a>
              <a className="text-slate-400 hover:text-white transition-colors duration-200 block mt-2.5 text-[12px] font-medium cursor-pointer">Blog Open</a>
              <a className="text-slate-400 hover:text-white transition-colors duration-200 block mt-2.5 text-[12px] font-medium cursor-pointer">Contact</a>
              <a className="text-slate-400 hover:text-white transition-colors duration-200 block mt-2.5 text-[12px] font-medium cursor-pointer">Privacy Policy</a>
              <a className="text-slate-400 hover:text-white transition-colors duration-200 block mt-2.5 text-[12px] font-medium cursor-pointer">404</a>
            </div>

            {/* Column 5: Download Badge Card */}
            <div className="bg-slate-900/40 border border-slate-800/80 rounded-[20px] p-5 flex flex-col gap-3 w-full max-w-[210px] lg:max-w-none">
              <span className="text-white font-bold text-[13px] mb-1 block leading-none">Download our App</span>

              {/* Google Play */}
              <button className="flex items-center gap-2 bg-slate-950 border border-slate-850 rounded-xl px-3.5 py-2 hover:bg-slate-900 transition-colors w-full cursor-pointer text-left">
                <svg className="w-5 h-5 text-white fill-current shrink-0" viewBox="0 0 24 24">
                  <path d="M3.609 1.814L13.783 12 3.609 22.186A2.22 2.22 0 013 20.57V3.43c0-.623.238-1.192.609-1.616zm11.29 9.068l2.946-2.946L3.921 2.67c.755-.386 1.838-.204 2.657.482l11.756 9.77a2.227 2.227 0 010 3.522l-11.756 9.77c-.819.686-1.902.868-2.657.482l13.924-5.266-2.946-2.946z" />
                </svg>
                <div className="flex flex-col items-start leading-none">
                  <span className="text-[7.5px] text-slate-400 uppercase font-bold tracking-wider">Get it on</span>
                  <span className="text-[11px] font-extrabold text-white mt-0.5 tracking-tight">Google Play</span>
                </div>
              </button>

              {/* App Store */}
              <button className="flex items-center gap-2 bg-slate-950 border border-slate-855 rounded-xl px-3.5 py-2 hover:bg-slate-900 transition-colors w-full cursor-pointer text-left">
                <svg className="w-5 h-5 text-white fill-current shrink-0" viewBox="0 0 24 24">
                  <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M15.97 4.17c.66-.81 1.11-1.93.99-3.06-1 .04-2.21.67-2.93 1.49-.62.69-1.16 1.84-1.01 2.96 1.12.09 2.27-.58 2.95-1.39z" />
                </svg>
                <div className="flex flex-col items-start leading-none">
                  <span className="text-[7.5px] text-slate-400 uppercase font-bold tracking-wider font-medium">Download on the</span>
                  <span className="text-[11px] font-extrabold text-white mt-0.5 tracking-tight">App Store</span>
                </div>
              </button>
            </div>
          ...
          <div className="border-t border-slate-900 mt-16 pt-8 flex flex-col sm:flex-row justify-between items-center text-[12px] text-slate-500 font-semibold gap-4">
            ...
            <div className="flex gap-6">
              ...
              <a className="hover:text-slate-300 transition-colors cursor-pointer">Terms of Services</a>
            </div>
          </div>
        </div>
      </footer>
